...
class TestCalculateOC(unittest.TestCase):
    ...
    def test_Calcualte_OC3(self):
        ...
        e, OC, OC_err, T0, T0_err = calculate_oc(2458843.932122, 0.00058, 2457143.761819, 0.00014, 0.31297)
